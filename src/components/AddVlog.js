...
const AddVlog = () => {
  ...
  const sendRequest = async() => {
    ...
    const res = await axios.post(`${API}/api/vlog/add`,{
  ...
  return (
    <div>
       <form onSubmit={handleSubmit}>
        <Box
        border={3}
        borderColor= "linear-gradient(43deg, #4158D0 0%, #C850C0 46%, #FFCC70 100%)"
        borderRadius={10}
        ...
        width={"80%"}>
          <Typography fontWeight={'bold'} padding={3} color="grey" variant="h2" textAlign={'center'}> Post Your Vlog </Typography>
